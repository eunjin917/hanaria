...
import com.hanaro.hanaria.dto.admin.member.MemberCreateRequestDto;
import com.hanaro.hanaria.dto.admin.member.MemberUpdateRequestDto;
...
public class MemberApiController {
    ...
    public String adminMemberCreate(@ModelAttribute MemberCreateRequestDto dto) {
        ...
        if (isAdded) {
            return "<script>alert('회원이 추가되었습니다.');location.href='/admin/members';</script>";
        } else {
